...
import { Amount, Form, AlertDialog, Back, Card, Flex, ButtonLoading } from '@stor/core';
import {
  Typography,
  Button,
  Box,
...
export default function WalletDIDCreate() {
  ...
  async function onSubmit(data) {
    try {
      ...
      const amount_val = stor_to_storoshi(data.amount);
      if (
        amount_val === '' ||
        Number(amount_val) === 0 ||
        !Number(amount_val) ||
          ...
          <Flex flexDirection="column" gap={3}>
            <Flex flexDirection="column" gap={1}>
              <Flex alignItems="center" gap={1}>
                ...
                <Tooltip title="The amount of Stor you enter must correspond to an even amount of storoshis. One additional storoshi will be added to the total amount for security purposes.">
                  ...
                  >
                    {() => (
                      <Flex display="flex" gap={1} alignItems="center">
                        ...
                        <Tooltip title="This additional storoshi will be added to the total amount for security purposes.">
                          <HelpIcon style={{ color: '#c8c8c8', fontSize: 12 }} />
                        </Tooltip>
                      </Flex>
                    )}
