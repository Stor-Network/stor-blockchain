...
import icon from '../../assets/img/stor_circle.svg';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2021 Stor Network<br />
        ...
        <BugReport
          href="https://github.com/Stor-Network/stor-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
