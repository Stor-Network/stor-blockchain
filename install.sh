...
if [ "$(uname -m)" = "armv7l" ]; then
  echo ""
	echo "WARNING:"
	echo "The Stor Blockchain requires a 64 bit OS and this is 32 bit armv7l"
	echo "For more information, see"
	echo "https://github.com/Stor-Network/stor-blockchain/wiki/Raspberry-Pi"
	echo "Exiting."
	exit 1
fi
...
echo ""
echo "Stor blockchain install.sh complete."
echo "For assistance join us on Stor Forum:"
echo "https://storforum.com"
echo ""
echo "Try the Quick Start Guide to running stor-blockchain:"
echo "https://github.com/Stor-Network/stor-blockchain/wiki/Quick-Start-Guide"
echo ""
echo "To install the GUI type 'sh install-gui.sh' after '. ./activate'."
echo ""
echo "Type '. ./activate' and then 'stor init' to begin."
