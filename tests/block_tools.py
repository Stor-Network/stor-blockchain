...
from stor.plotting.create_plots import create_plots
...
from stor.consensus.cost_calculator import NPCResult, calculate_cost_of_program
...
from stor.plotting.plot_tools import PlotInfo, load_plots, parse_plot_info
...
from stor.types.name_puzzle_condition import NPC
from stor.util.bech32m import encode_puzzle_hash
from stor.util.block_cache import BlockCache
from stor.util.condition_tools import ConditionOpcode, conditions_by_opcode
...
class BlockTools:
    ...
    def init_plots(self, root_path: Path):
        ...
        try:
            ...
            args.pool_contract_address = encode_puzzle_hash(self.pool_ph, "stor")
