...
from stor.pools.pool_config import PoolWalletConfig
from stor.util.config import load_config, save_config, create_default_stor_config
...
def test_pool_config():
    ...
    create_default_stor_config(test_root, ["config.yaml"])
