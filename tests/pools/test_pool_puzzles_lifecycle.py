...
from stor.wallet.puzzles.p2_conditions import puzzle_for_conditions
from stor.wallet.puzzles import singleton_top_layer
from stor.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    ...
    - stor.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
...
class TestPoolPuzzles(TestCase):
    def test_pool_lifecycle(self):
        ...
        GENESIS_CHALLENGE = bytes32.fromhex("9bc2787915702f8c60cd7456dfb2b62237e92153cbcef895f95bba70116ac950")
