...
from stor.server.start_full_node import SERVICE_NAME
...
from stor.consensus.pot_iterations import calculate_iterations_quality
from stor.full_node.weight_proof import (  # type: ignore
    WeightProofHandler,
