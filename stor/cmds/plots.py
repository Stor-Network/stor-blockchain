...
def show_plots(root_path: Path):
    from stor.plotting.plot_tools import get_plot_directories
...
def add_cmd(ctx: click.Context, final_dir: str):
    from stor.plotting.plot_tools import add_plot_directory
...
def remove_cmd(ctx: click.Context, final_dir: str):
    from stor.plotting.plot_tools import remove_plot_directory
