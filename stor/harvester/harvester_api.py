...
from stor.harvester.harvester import Harvester
from stor.plotting.plot_tools import PlotInfo, parse_plot_info
from stor.protocols import harvester_protocol
from stor.protocols.farmer_protocol import FarmingInfo
from stor.protocols.harvester_protocol import Plot
from stor.protocols.protocol_message_types import ProtocolMessageTypes
from stor.server.outbound_message import make_msg
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSStorConnection
    ):
        """
